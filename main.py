...
def single_prediction_route_client():
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            mean_smootheness = request.form["mean_smootheness"]


            data = pd.DataFrame(data=[[mean_radius ,mean_texture, mean_perimeter, mean_area,mean_smootheness]],
                              columns=['mean_radius','mean_texture', 'mean_perimeter', 'mean_area','mean_smootheness'])
            # using dictionary to convert specific columns
            convert_dict = {'mean_radius': float,
                'mean_texture': float,
